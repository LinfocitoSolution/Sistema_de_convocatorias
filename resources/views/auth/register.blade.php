							           ...
							           <form name="fregistro" class="form-group" method="POST" action={{url("/register")}}  id="formReg" autocomplete="off" >                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       	 
									     ...
									     <div class="form-row" > 
										          <!--campo nombre-->
								                   ...
								                   <!--campo apellido-->
								                      <div class="col-md-6 mb-2">
                                                              <label for="validationTooltip02"class="text-black"><b class="text-danger">(*)</b>Apellido completo</label>
									              ...
									              <!--campo carrera--->
									                 <div class="col-md-6 mb-2">
								                             <label for="validationTooltip04"class="text-black"><b class="text-danger">(*)</b>Carrera</label>
									              ...
									              <!--campo email-->
									               ...
									               <!---fin campo email--->
									                <!--campo contraseña-->
									                   <div class="col-md-6 mb-2">
								                           <label for="validationTooltip06"class="text-black"><b class="text-danger">(*)</b>Contraseña</label>
