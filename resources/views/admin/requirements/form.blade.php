<div class="form-row">
    ...
    <div class="col-md-12 mb-3">
        ...
        <input
                        class="form-control text {{ $errors->has('nombre_auxiliatura') ? 'is-invalid' : '' }}"
    ...
    <div class="col-md-12 mb-3">
        ...
        <input
                    class="form-control text {{ $errors->has('codigo_auxiliatura') ? 'is-invalid' : '' }}"
   ...
   <div class="col-md-12 mb-3">
    ...
    <div class="input-group" data-html="true"  data-toggle="popover" title="Restricciones" data-content="-M&iacute;nimo 1 <br> -el rango de digitos de la cantidad de auxiliares esta entre 1-5, <br> -la cantidad de auxiliares solo debe ser numeros">
      <span class="input-group-append">
        ...
        <input
                    class="form-control text {{ $errors->has('cantidad_de_auxiliares') ? 'is-invalid' : '' }}"
