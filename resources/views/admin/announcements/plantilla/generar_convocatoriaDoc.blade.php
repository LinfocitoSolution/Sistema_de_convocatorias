   ...
   <div class="hoja" id="datos">  
    ...
    <p  class="parrafo" style="text-align:justify">La calificación de méritos se basará en los documentos presentados por el postulante y se 
              ...
              <div class="container">
               <div class="card-body">
                   <table class="table" border="1px">
                       ...
                       <tbody>
                           <tr>
                               <td colspan="2"><strong>RECONOCIMIENTO ACADEMICO</strong> </td>
                           ...
                           <tr>
                            ...
                            <tr>
                               <td colspan="3"><strong>EXPERIENCIA GENERAL</strong></td>
                           </tr>
                            <tr>
                            ...
                            <tr>
                               <td colspan="2"><strong>Documentos de experiencia universitaria</strong></td>
                               <td align="right"><strong>25%</strong></td>
                           </tr>
                            <tr>
                               <td colspan="3">
                                   <P>a.-) Auxiliar docente en materias del área troncal: …..…….…… 15% </P>
                                   <p style="padding-left: 40px">a.-  2 ptos/semestre y materia de aux. titular</p>
                                   <p style="padding-left: 40px">b.-  1 ptos/semestre y materia de aux. invitado</p>
                                   <p style="padding-left: 40px">c.-  1 ptos/semestre y materia de aux. de practicas </p>
                                   <P>b.-) Auxiliar en otras ramas o carreras:…………………………………. 5% </P>
                                   <p style="padding-left: 40px">a.-  1 pto/semestre x materia de aux. invitado o titular</p>
                                   <p style="padding-left: 40px">b.-  1 pto/semestre x materia de aux. de practicas</p>
                                    <P>c.- ) Disertación cursillos y/o participación en Proyectos:……... 5% </P>
                                    <p style="padding-left: 40px">a.-  3 ptos por dirección de cursillo</p>
                                   <p style="padding-left: 40px">b.-   2 ptos por participación en proyectos</p>
                                   <P style="padding-left: 40px"> (Certificado con especificación de labores)</P>
                               </td>
                           </tr>
                            <tr>
                               <td colspan="2"><strong>Documentos de experiencia extrauniversitaria</strong></td>
                               <td align="right"><strong>10%</strong></td>
                           </tr>
                            <tr>
                               <td colspan="3"><P>a.-Experiencia como operador, programador, analista de sistemas, cargo
                                 directivo en centro de cómputo …………………..……………... 5%</P>
                                   <p style="padding-left: 40px">a. 1 punto cargo/semestre</p>
                                   <P>b.- Experiencia docente en colegios, institutos, etc ……..…… 5%</P>
                                   <P style="padding-left: 40px">a.  1 punto cargo/semestre y certificado </P>
                                   <P>d.-</P>
                               </td>
                           </tr>
                       </tbody>
       ...
       <p> b) Examen oral, donde se evaluarán aspectos didácticos y pedagógicos sobre
           conocimiento y dominio de la materia.Tendrá una duración máxima de 25 minutos@auth
