                      ...
                      <div class="modal-content" >
                        ...
                        <div class="modal-body" id="ventana">
                         ...
                         <div class="input-group">
                            ...
                            <div class="input-group-prepend">
                              <span class="input-group-text text-white">Descripción</span>
                            </div>
                            <textarea class="form-control" aria-label="With textarea" name="descripcion" value="" id="descripcion">Su solicitud fue rechazada debido a la falta de los siguientes puntos:
</textarea>
                          </div>
                        </div>
