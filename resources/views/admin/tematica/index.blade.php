                                ...
                                <td>
                                    ...
                                    <form action="{{route('tematica.destroy',$call)}}" method="POST" style="display:inline-block;">
                                        ...
                                        @if ($call->publicado == 'no')
                                            <button class="btn btn-dark btn-sm mx-1 my-1" data-toggle="tooltip" data-trigger="hover" title="Presiona para elimar las temáticas" type="submit" margin-left="50" onclick="return confirm('Está seguro de eliminar las temáticas?')">
