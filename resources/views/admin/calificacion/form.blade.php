<div class="form-row">
   ...
   <label class="col-form-label" for="name">Nombre de Mérito</label>
...
<div class="col-md-6 mb-2">
    <label class="col-form-label" for="nameReque">Sub-Méritos</label>
   <div class="input-group">
      <span class="input-group-append"  data-html="true" data-toggle="popover" title="Restricciones" data-content="-Debe seleccionar al menos un requerimiento para continuar.">
        <button class="btn btn-dark" type="button">SM</button>
      </span>
